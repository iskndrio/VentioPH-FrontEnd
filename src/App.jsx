    ...
    <div className="text-gray-900">
      ...
      >
        ...
        <div className="text-center max-w-2xl px-6 relative z-10">
          ...
          >
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maiores, dolore numquam.
          </p>
          <a
            href="https://wa.me/"
            target="_blank"
      ...
      <section id="about" className="py-24 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          >
            ...
            fugiat praesentium ab autem hic reiciendis beatae corporis aut ipsa
            suscipit!
          </p>
        </div>
      </section>
      ...
      <section id="services" className="py-24">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 border hover:shadow-xl transition">
            ...
            <div className="p-8 border hover:shadow-xl transition">
              ...
              <p className="text-gray-600" style={{ fontFamily: "Poppins" }}>
                ...
                quos, nihil corporis rerum dolorem cum mollitia cupiditate ex
                dolor id!
              </p>
            </div>
          </div>
